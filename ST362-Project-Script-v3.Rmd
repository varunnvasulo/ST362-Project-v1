...
```{r}
DATA <- read.csv("/Users/skinj/OneDrive/Desktop/2022-2023 NBA Player Stats - Regular.csv")
# 
...
write.csv(DATA_NBA23, file= "/Users/skinj/OneDrive/Desktop/ST362_NBA23.csv", row.names = FALSE)
```
